...
return(
  ...
  <h3 className="text-6xl font-semibold tracking-widest dark:text-cyan-400/80 text-black ">Let's have a chat</h3>
  <button  type="button" className="flex text-md tracking-widest gap-3 px-6 py-3 hover:bg-cyan-400 hover:text-black  hover:cursor-pointer hover:scale-[0.98]  active:scale-[1.02] hover:shadow-xs font-semibold transition-all duration-300 ease-in-out hover:shadow-cyan-400 dark:text-cyan-400 border border-cyan-500 rounded-lg">
